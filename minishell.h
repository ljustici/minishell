...
/*   Updated: 2024/02/11 15:21:19 by roruiz-v         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 	NONE 0	-> redir struct 'type' = NONE (no redirs)
 ...
 #  CODED 5	-> redir struct 'type' = redir already defined by
 	code (TO ELIMINATE !!!)
 * */
typedef enum e_type
{
...
int			assign_quoted_token(t_lexer lex, size_t *i, int *j,
				int f_letter_pos);
...
void		ft_builtin_cd_without_args(t_msh *data, t_cmd *cmd_nd,
				int exit_code);
